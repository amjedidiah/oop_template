    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-12 shadow p-5">
                ...
                <h2 class="my-4 mail"></h2>
                <div>You have one more step remaining to activate your MEGA account. Click on the button below to verify
                    your
                    email address: <br /><a href="https://weekvest.com/verify=" class="btn btn-success my-1">Verify my
                        email</a></div>

                <div class="mt-3">
                    <p>Didn’t work? Copy and visit the link below into your web browser:
                        <br /><a href="https://weekvest.com/verify="
                            class="text-success verify">https://weekvest.com/verify=</a>
                    </p>
                </div>
